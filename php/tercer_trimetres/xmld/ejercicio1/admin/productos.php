                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="generos.php" class="dropdown-item">Generos</a>
                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Hoy vendido en total:</p>
                                <h6 class="mb-0">
                                <?php
                                if(isset($_SESSION["total"])){
                                    if(strlen($_SESSION["total"])>=1){
                                        echo $_SESSION["total"];
                                    }
                                }
                                ?>
                        ...
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                if(isset($_SESSION["ventas"])){
                                    if(strlen($_SESSION["ventas"])>=1){
                                        echo $_SESSION["ventas"];
                                    }
                                }
                                ?>
...
<?php
    ...
    <form class="container-fluid" action="modificarProducto.php?id=-1&nombreGenero= &nombre= &idCat=-1&precio=" method="post">
        <input class="btn btn-light m-2" type="submit" value="NUEVO PRODUCTO">
    </form>
