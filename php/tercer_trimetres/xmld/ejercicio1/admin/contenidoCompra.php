...
<div class="container-fluid position-relative d-flex p-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            ...
                            $query = "select * from notificaciones limit 5";
    ...
    <?php 
        if(isset($_GET["id"])&& isset($_GET["fecha"])&&isset($_GET["total"])){
            include("db_conect.php");
            $id = $_GET["id"];
            $query =  "select  producto.nombre Producto, cantidad, cliente.nombre Cliente,  producto.precio precio  
            ...
            <table class="table table-dark table-responsive"">
                 <thead>
                    <tr>
                        ...
                        <th scope="col">Nombre y Apellido de cliente</th>
...
<?php                
    ...
    <p class="btn btn-secondary m-2"><a href="compras.php">Volver</a></p>
