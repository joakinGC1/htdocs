                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Modificar Datos del cliente.</h6>
                            <form action="../includes/modificar_cliente.php" method="post">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="nombre" name="apellido" value="<?= $_GET["apellido"]?>">
                                    
                                    
                                </div> 
                                <input type="submit" class="btn btn-primary m-2" value="Enviar">
                                <p class="btn btn-secondary m-2"><a href="clientes.php">Volver</a></p>
                            </form>
                        </div>
                    </div>
                </div>
