...
<form class="container-fluid" action="modificarCliente.php?id=-1&nombre= &apellido=" method="post">
        <input class="btn btn-light m-2" type="submit" value="NUEVO CLIENTE">
    </form>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            ...
                            Designed By <a href="3">HTML Codex</a>
